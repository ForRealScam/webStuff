...
export default function Cursor() {
  useEffect(() => {
    ...
    const build = (positionClass, shapeClass) => {
      const holder = document.createElement('div')
      holder.className = `cursor-pos ${positionClass}`
    ...
    const ringPos = build('ring-pos', 'cursor-ring')
    const dotPos = build('dot-pos', 'cursor-dot')
    const ring = ringPos.firstChild
